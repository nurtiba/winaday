...
export default function BuildPage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#0a0a0a] px-5 safe-top safe-bottom text-white">
      <div className="mb-5">
        ...
        <p className="mt-2 text-[14px] leading-relaxed text-[#777]">
          Set the bare minimum for each life stat. You can change this next week.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="mt-3 min-h-[44px] w-full rounded-xl border border-dashed border-[#303046] text-[13px] font-bold text-[#777] disabled:opacity-30"
              >
                Add non-negotiable ({items.length}/5)
              </button>
            </section>
          );
        })}
      ...
      <div className="fixed bottom-0 left-1/2 w-full max-w-[430px] -translate-x-1/2 bg-[#0a0a0a]/95 px-5 pb-[max(env(safe-area-inset-bottom),16px)] pt-3">
